...
Does a soccer team meeting or exceeding their xG mean that they will win their games? In this study, I plan to examine the expected goal ratio (xG) of English Premier League teams to their actual goals and see if teams that met or exceeded their xG won the majority of their games. I hypothesize that teams will win most (51%) of their league games if their expected goals ratio (xG) is met or exceeded. My sample is comprised of the 20 Premier League teams in the 2016 season. I will be using the spi.matches.csv dataset and looking at the xg1 (the number of expected goals created by a home team), xg2 (the number of expected goals created by an away team), score1 (the number of goals scored by the home team), and score2 (the number of goals scored by the away team). 
